...
<div class="container-fluid mt-5">
    <div class="container">
        <div class="card">
            <form action="index.php?id=114" method="POST">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="customTitle">Ajouter un dossier</h1>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                <input type="text" name="title" class="form-control" placeholder="Dossier de Lucien Muyer" aria-label="Recipient's username" aria-describedby="button-addon2">
                                <div class="input-group-append">
                ...
                <div class="card-footer">
                    ...
                    <input type="hidden" name="id_user" value="<?= $_SESSION['acces']['id_user'] ?>">
