<?php
 if( !isset($_SESSION['acces'])){
    ...
    require './app/bdd.php';
    $grade = $connexion->prepare('SELECT user.id_user ,user.matricule, user.nom,user.prenom, grade.label FROM user, grade where user.id_grade = grade.id_grade AND isDelete = 0 ORDER BY user.id_grade DESC');
    $grade->execute();
...
<table class="table mt-4">
    ...
    foreach ($resultat as $key) {
      ...
      <tr>
        ...
        <td>
          <a href="index.php?id=23&id_user=<?= $key['id_grade'] ?>">
